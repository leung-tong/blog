...
@section('js')
    ...
    <script type="text/html" id="popForm">
        <div class="layui-fluid">
            <div class="layui-form layui-form-pane popForm" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="url" autocomplete="off" placeholder="请输入路由方法" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
            ...
            table.render(
                {
                    ...
                    , cols: [[
                        ...
                        , {
                            field: 'url', title: '方法', align: 'center', templet: function (d) {
            ...
            table.on('toolbar(test)', function (obj) {
                ...
                if (obj.event === 'add') {
                    layer.open({
                        ...
                        , btn1: function () {
                            $.ajax({
                                url: "{{ url('/admin/permission/insert') }}",
                                type: 'post',
                                data: {
